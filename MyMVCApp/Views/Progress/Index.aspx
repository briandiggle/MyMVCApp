...
<th>Progress Bar</th>
<% 
    Dim oProgressList As List(Of WalkingMVC.WalkingMVC.MyProgress) = ViewData("oProgress")
    Dim iProgressBarTotalPixels = 500
    Dim dPercentComplete As Double
    Dim iCompletePixels As Integer
    
    For Each oClassProgress As WalkingMVC.WalkingMVC.MyProgress In oProgressList
...
%>        
  ...
  <tr>
        <td><%= WalkingMVC.WalkingMVC.Helpers.WalkingStick.HillClassToLink(oClassProgress.ClassRef, "")%></td>
        <td><%= WalkingMVC.WalkingMVC.Helpers.WalkingStick.HillClassToLink(oClassProgress.ClassRef, oClassProgress.ClassName)%></td> 
