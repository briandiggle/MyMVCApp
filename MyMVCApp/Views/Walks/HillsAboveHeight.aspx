<%@ Page Title="" Language="VB" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage(Of IEnumerable (Of WalkingMVC.WalkingMVC.Hill))" %>
    ...
    <% For Each item In Model%>
        ...
        <tr>
            <td>
                ...
                <%= Html.ActionLink("Delete", "Delete", New With {.id = item.Hillnumber})%>
            </td>
            <td>
