<%@ Page Title="" Language="VB" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage(Of WalkingMVC.PaginatedListMVC (Of WalkingMVC.WalkingMVC.Hill))" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%  Dim iHillNumberInClassification = ((Model.PageIndex - 1) * Model.PageSize) + 1
        ...
        <tr style="background-color: <%=WalkingMVC.WalkingMVC.Helpers.WalkingStick.NumberOfAscentsAsColour(item.NumberOfAscents) %>">
            ...
            <td class="hillclasses">
                <%= WalkingMVC.WalkingMVC.Helpers.WalkingStick.HillClassesToLinks(item.Classification)%>
            </td>
            <td>
