<%@ Page Title="" Language="VB" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage(Of WalkingMVC.PaginatedListMVC (Of WalkingMVC.WalkingMVC.Walk))" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% For Each item In Model%>
        ...
        <tr>
         ...
         <td>
                <%: WalkingMVC.WalkingMVC.Helpers.WalkingStick.ConvertTotalTimeToString(item.WalkTotalTime, True)%>
            </td>      
            <td>
