...
<%  For Each oHillAscent As MyMVCApp.DAL.HillAscent In Model.HillAscents%>
    <tr>
        <td><%= Html.ActionLink(oHillAscent.Hill.Hillname, "HillDetails", "Walks", New With {.id = oHillAscent.Hillnumber}, Nothing)%></td>
