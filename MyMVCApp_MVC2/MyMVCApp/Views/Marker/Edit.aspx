    ...
    <%  Using Html.BeginForm("Edit", "Marker", FormMethod.Post, New With {.id = "editmarkerform", .name = "editmarkerform"})%>
        ...
        <fieldset>
            ...
            <div class="editor-field">
                ...
                <input type="text" name="LeftOnHillName" id="LeftOnHillName" size="80" value="<%= WalkingMVC.WalkingMVC.Helpers.WalkingStick.FormatHillSummaryAsLine(Model.Hill) %>" />
            </div>&nbsp;
            ...
            <div class="editor-field">
                ...
                <input type="text" name="MarkerLeftOnWalkName" id="MarkerLeftOnWalkName" value="<%= WalkingMVC.WalkingMVC.Helpers.WalkingStick.FormatWalkAsLine(model.Walk) %>"size="80"/>
            </div>&nbsp;
            ...
            <div class="editor-field">
                <select name="Status">
                <%  For Each oStatus As WalkingMVC.WalkingMVC.Marker_Status In ViewData("Marker_Status") %>
                      <option value="<%= oStatus.Marker_Status %>" <% If oStatus.Marker_Status.Equals(Model.Status) Then Response.Write(" selected") %>><%= oStatus.Marker_Status%></option>
                <%    Next%>
                </select>
