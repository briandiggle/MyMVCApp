    ...
    <%  Using Html.BeginForm("Edit", "Marker", FormMethod.Post, New With {.id = "editmarkerform", .name = "editmarkerform"})%>
        ...
        <fieldset>
            ...
            <div class="editor-field">
                ...
                <input type="text" name="LeftOnHillName" id="LeftOnHillName" size="80" value="<%= MyMVCAppCS.Models.WalkingStick.FormatHillSummaryAsLine(Model.Hill) %>" />
            </div>&nbsp;
            ...
            <div class="editor-field">
                ...
                <input type="text" name="MarkerLeftOnWalkName" id="MarkerLeftOnWalkName" value="<%= MyMVCAppCS.Models.WalkingStick.FormatWalkAsLine(model.Walk) %>"size="80"/>
            </div>&nbsp;
            ...
            <div class="editor-field">
                <select name="Status">
                <%  For Each oStatus As MyMVCAppCS.Models.Marker_Status In ViewData("Marker_Status")%>
