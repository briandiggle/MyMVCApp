<%@ Page Title="" Language="VB" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage(Of MyMVCApp.DAL.Hill)" %>
...
<%  Dim iAscentCounter As Integer = 1
    ...
    Dim oAscents As IEnumerable(Of MyMVCApp.DAL.HillAscent) = ViewData("HillAscents")
    
    For Each oAscent As MyMVCApp.DAL.HillAscent In oAscents%>
    <tr>
